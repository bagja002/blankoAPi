...
func SetupRoutesFiber(app *fiber.App) {
	...
	lemdik.Put("/updatePelatihanUsers", middleware.JwtProtect(), controllers.UpdateUsersPelatihanUsers)
	lemdik.Put("/updatePelatihanUsers", middleware.JwtProtect(), controllers.UpdateUsersPelatihanUsers)
	//lemdik Area
	...
	lemdik.Post("/exportModulePelatihan", middleware.JwtProtect(), controllers.ImportMateriPelatihan)
